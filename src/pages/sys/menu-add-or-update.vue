        ...
        <el-row>
          ...
          <el-col :span="2" class="icon-list__tips">
            <el-tooltip placement="top" effect="light">
              <div slot="content">全站推荐使用SVG Sprite, 详细请参考:<a href="xxx" target="_blank">icons/index.js</a>描述</div>
    ...
    methods: {
      init(val) {
        ...
        if (val[0]) {
          ...
          const {menuId,type,name,parentId,url,perms,orderNum,icon} = val[1]
          ...
          getList().then(({data}) => {
            ...
            this.menuList = treeDataTranslate(dataList, 'menuId')
          }).then(() => {
